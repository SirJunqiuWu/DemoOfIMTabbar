...
int const topLineTag    = 1000000;
int const bottomLineTag = 1000001;
...
- (void)drawTopLine {
    ...
    UIView *line = [[UIView alloc]initWithFrame:AppFrame(0, 0, self.width,AppLineHeight)];
...
- (void)drawBottomLine {
    ...
    UIView *line = [[UIView alloc]initWithFrame:AppFrame(0,self.height-AppLineHeight, self.width,AppLineHeight)];
    line.backgroundColor = CD_LineColor;
